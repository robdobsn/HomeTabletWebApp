...
TileGroup = (function() {
  ...
  TileGroup.prototype.getColsInGroupSimple = function(tilesDown) {
    var colIdx, i, rowIdx, tile, vacantCells, _i, _j, _len, _ref, _ref1, _ref2;
    this.tilePositions = [];
    vacantCells = [];
    colIdx = 0;
    rowIdx = 0;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      tile = _ref[_i];
      while (_ref1 = colIdx + rowIdx * 100, __indexOf.call(vacantCells, _ref1) >= 0) {
        rowIdx += 1;
        if (rowIdx >= tilesDown) {
          rowIdx = 0;
          colIdx += 1;
      ...
      this.tilePositions.push([colIdx, rowIdx]);
      if (tile.colSpan > 1) {
        for (i = _j = 1, _ref2 = tile.colSpan - 1; 1 <= _ref2 ? _j <= _ref2 : _j >= _ref2; i = 1 <= _ref2 ? ++_j : --_j) {
